...
presupuestado = [3814184, 235305, 514713, 977200, 1056757]
ejecutado = [638155, 11383, 482985, 64856, 354298]
tituloText = "Agenda Digital ( Ejecutado a Febrero 2019-2021)"
...
fig.add_trace(go.Bar(x=ejeX, y=presupuestado, name='Presupuestado'))
fig.add_trace(go.Bar(x=ejeX, y=ejecutado, name='Ejecutado'))
