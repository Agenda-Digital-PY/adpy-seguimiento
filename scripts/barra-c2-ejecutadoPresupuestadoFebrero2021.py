...
"""
presupuestado = [42985, 192320]
ejecutado = [5373,6010]

tituloText = "Agenda Digital Componente II (Febrero 2019-2021)"
...
pio.write_html(fig, file='../_includes/plotly-barra-cii-ejecutadoFebrero2021.html', auto_open=True)
